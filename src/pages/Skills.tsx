      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A comprehensive overview of my technical expertise across full-stack
            development, database management, cloud technologies, and modern
          ...
          {skillCategories.map((category, index) => (
            <Card key={index} className="p-6 hover-lift">
              <div className="flex items-center mb-6">
                <div
                  className={`p-3 ${category.color} rounded-lg text-white mr-4`}
                >
                  {category.icon}
                </div>
                  ...
                  <div key={skillIndex} className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`text-xs px-2 py-1 rounded-full text-white ${getSkillLevelColor(
                            skill.level
                          )}`}
                        >
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 rounded-2xl p-8">
            ...
            <div className="mt-8 text-center">
              <p className="text-muted-foreground max-w-2xl mx-auto">
                These skills have been honed through real-world projects in
                government initiatives, renewable energy solutions, and
